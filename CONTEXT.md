...
WSL ./agent/agent  (Go binary at agent/agent)
   ↓ ECOTRACE_SERVER=https://sheet-sites-drinks-situated.trycloudflare.com
...
- **Repo-root `.env`** holds secrets:
  ...
  - `CORS_ALLOWED_ORIGINS` includes `https://sheet-sites-drinks-situated.trycloudflare.com`
...
setsid bash -c 'ECOTRACE_SERVER=https://sheet-sites-drinks-situated.trycloudflare.com \
  ECOTRACE_INSECURE_TLS=true \
  BOOTSTRAP_TOKEN=8c08b5f86085ba7b55469ae22458d792611f6a683868c4db042a9a1aa30c01c2 \
...
```bash
TOKEN=$(curl -k -sS -X POST "https://sheet-sites-drinks-situated.trycloudflare.com/api/auth/login" \
